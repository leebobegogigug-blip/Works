<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="terminal-1/docs/images/page/hero-dark.jpg">
    <img src="terminal-1/docs/images/page/hero-light.jpg" width="880" alt="Terminal–1 채널 탭 — opencode · status · compose · usage · TOKEN QUEST 다섯 칸이 한 창에">
  </picture>
</p>

<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="terminal-1/docs/images/page/title-dark.png">
    <img src="terminal-1/docs/images/page/title-light.png" width="880" alt="opencode 멀티플렉서 — Terminal–1 works — 창은 하나, opencode 는 여럿.">
  </picture>
</p>
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="terminal-1/docs/images/page/detail-dark.jpg">
    <img src="terminal-1/docs/images/page/detail-light.jpg" width="880" alt="NEW! 한 서버엔 한 번만 — 같은 서버를 보는 칸이 여럿이어도 opencode 조회는 한 칸만">
  </picture>
</p>
...
<p align="center"><img src="terminal-1/docs/images/page/status.png" width="760" alt="status 칸 — 01 TOKENS 세그먼트 숫자, 02 SESSIONS 세션 트리와 PERM · BUSY 칩, 03 EVENTS, 04 LOGS"></p>
...
<p align="center"><img src="terminal-1/docs/images/page/compose.png" width="640" alt="compose 칸 — 큰 입력 상자와 넣기 · 전송 · 복구 · 지우기 키"></p>
...
<p align="center"><img src="terminal-1/docs/images/page/usage.png" width="480" alt="usage 칸 — 분당 토큰 세그먼트 숫자와 10초 막대 차트"></p>
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="terminal-1/docs/images/page/overview-dark.jpg">
    <img src="terminal-1/docs/images/page/overview-light.jpg" width="880" alt="00 overview 탭 — 모든 채널의 토큰 합계, 인스턴스 표, 진행 중 작업, 이벤트, 로그, 채널별 믹서, 펫 목장">
  </picture>
</p>
...
<p align="center"><img src="terminal-1/docs/images/page/status-guide.png" width="760" alt="? 가이드 — 구역마다 붙은 번호표와 아래 띠의 이름 · 설명"></p>
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="terminal-1/docs/images/page/pet-dark.png">
    <img src="terminal-1/docs/images/page/pet-light.png" width="880" alt="TOKEN QUEST — 홈 화면과 주간 레이드 화면">
  </picture>
</p>
...
<p align="center"><img src="terminal-1/docs/images/page/story-talk.png" width="640" alt="메인 스토리 대화 화면 — 야근의 탑"></p>
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="terminal-1/docs/images/page/palette-dark.png">
    <img src="terminal-1/docs/images/page/palette-light.png" width="880" alt="팔레트: 인코더 네 색(파랑 #75A1C7 · 라임 #6ABA23 · 흰색 #F2F2F3 · 회색 #A5AAAE)과 네이비 · 라임 · 회색 밝기 단계">
  </picture>
</p>
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="terminal-1/docs/images/page/certified-dark.png">
    <img src="terminal-1/docs/images/page/certified-light.png" width="880" alt="Terminal–1 works — 야근의 탑, 공략 가능.">
  </picture>
</p>
...
<a href="terminal-1/README.md#06-token-quest">TQ–1 token quest ›</a>
</p>
...
<p align="center">opencode 를 열고 <code>terminal-1/INSTALL.md 를 읽고 순서대로 Terminal-1 설치를 진행해줘</code> 라고 하면 됩니다.<br>직접 할 때는:</p>
...
<p align="center"><sub>예전 이름(ocmux)으로 쓰고 있었다면: <code>git pull</code> 뒤 <code>D:\OPENCODE\terminal-1\terminal-1.cmd setup</code> 한 번. 데이터 폴더 · PATH · 색 테마가 새 이름으로 옮겨집니다 (펫 저장 그대로) — <a href="terminal-1/README.md#예전-이름ocmux에서-넘어올-때">자세히</a></sub></p>
...
<table align="center">
<tr><td width="620"><a href="terminal-1/README.md">매뉴얼</a> <sub>· 명령 · 레이아웃 · 키 · 화면 · 구조</sub></td><td align="right" width="40">›</td></tr>
<tr><td><a href="terminal-1/INSTALL.md">설치 가이드</a> <sub>· opencode 에이전트용 단계별 절차</sub></td><td align="right">›</td></tr>
<tr><td><a href="terminal-1/README.md#06-token-quest">TOKEN QUEST</a> <sub>· 돌봄 · 진화 · 모험 · 레이드 · 메인 스토리</sub></td><td align="right">›</td></tr>
<tr><td><a href="terminal-1/README.md#07-디자인">디자인</a> <sub>· 규칙 일곱 가지 · 색 · 움직임</sub></td><td align="right">›</td></tr>
<tr><td><a href="terminal-1/docs/GUIDE.md">GUIDE (English)</a> <sub>· detailed manual</sub></td><td align="right">›</td></tr>
<tr><td><a href="https://github.com/leebobegogigug-blip/Works/issues">문제 알리기</a> <sub>· 이슈</sub></td><td align="right">›</td></tr>
<tr><td><a href="https://github.com/leebobegogigug-blip/jaba">Secretary–1</a> <sub>· works 시스템의 다른 부품</sub></td><td align="right">›</td></tr>
</table>
