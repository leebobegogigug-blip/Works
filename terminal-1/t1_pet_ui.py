...
from t1_term import (RST, B, rgb, bg, vlen, clip, pad, wrap, cw, norm_key, is_hangul, P3,
        ...
        if g.readonly:
            ...
            if k == "o":
                ...
                if res is None:
                    ...
                    self._toast("새 버전 Terminal–1이 만든 저장이라 이 창에선 읽기만 할 수 있어요", 4)
                else:
...
def render_ranch(scopes, W, H, reg_colors=None, anchors=None):
    ...
    anchors: `?` 가이드 번호표 자리 [(x, y, key)] (t1_monitor.MON_GUIDE 의 ranch/raidbar/cards)"""
