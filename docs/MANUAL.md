...
| # | 구역 | 보여 주는 것 |
|---|---|---|
| 01 | **NEXT** | 다음 일정까지 남은 시간 (진행 중이면 끝날 때까지 · 알림 시각부터 깜빡임) · 장소 · 위키 버튼 · JB–1 |
...
jaba 와 [ocmux](https://github.com/leebobegogigug-blip/Works)는 같은 디자인 규칙을 씁니다.
...
| 2 | **색 = 조작** | 노브 ①파랑 ②라임 ③흰색 ④회색 = ocmux 인코더와 같은 순서. 번호표도 그 색 |
...
| 7 | **캐릭터** | JB–1 — 네모 화면 얼굴 · 노브 · 안테나 불빛. 표정 8가지 |
